...
function ModalContentNewProjectForm({ onCancel, template = 'none' }: Props) {
  ...
  const createNewProject = () => {
    ...
    runAsync(postJSON('/project/new', { body }))
      .then(data => {
        if (data.project_id) {
          setRedirecting(true)
      ...
      <OLModalBody>
        ...
        <OLForm onSubmit={handleSubmit}>
          ...
          <Collapse in={showWebDAVConfig}>
            <div>
              <OLFormGroup controlId="webdav-url-new">
              ...
              <OLFormGroup controlId="webdav-username-new">
                <OLFormCheckbox
                  label={t('use_username')}
                  checked={useUsername}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setUseUsername(e.target.checked)
                  }
                />
                {useUsername && (
                  <OLFormControl
              ...
              <OLFormGroup controlId="webdav-password-new">
                <OLFormCheckbox
              ...
              <OLFormGroup controlId="webdav-base-path-new">
