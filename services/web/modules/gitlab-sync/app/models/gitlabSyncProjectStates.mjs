...
export const GitLabSyncProjectStatesSchema = new Schema(
  {
  ...
  { collection: 'gitlabSyncProjectStates', minimize: false }
)

export const GitLabSyncProjectStates = mongoose.model(
  'GitLabSyncProjectStates',
  GitLabSyncProjectStatesSchema,
)
