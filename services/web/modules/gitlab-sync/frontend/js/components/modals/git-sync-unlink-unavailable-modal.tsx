...
const GitSyncUnlinkUnavailableModal = ({
  ...
  const handleUnlink = () => {
    runAsync(deleteJSON(`/project/${projectId}/gitlab-sync`))
  ...
  return (
    <>
      <OLModalBody>
        <OLNotification
          type="error"
          content={t('gitlab_sync_repository_not_found_description')}
        />
          ...
          <OLNotification
            ...
            content={
              error.info?.statusCode === 403 ? (
                <Trans
                  i18nKey="ask_proj_owner_to_unlink_from_current_gitlab"
