...
const GitSyncExportModal = ({
  ...
  useEffect(() => {
    runAsyncUserAndOrgs(getJSON('/user/gitlab-sync/orgs'))
  ...
  const createRepo = () => {
    ...
    runAsync(postJSON(`/project/${projectId}/gitlab-sync/export`, {
      body: {
        name: repoName,
        description,
        isPublic,
  ...
  return (
    <>
      <OLModalBody>
        <h4>{t('export_project_to_gitlab')}</h4>
        <p>{t('project_not_linked_to_gitlab')}</p>
        ...
        <OLForm onSubmit={createRepo}>
          <OLRow>
            <OLCol xs={4}>
              <OLFormGroup>
                <OLFormLabel htmlFor="gitlab-sync-owner">
                  {selectedOwner === userAndOrgs?.user
                    ? t('owner')
                    : t('organization')}
                </OLFormLabel>
                <OLFormSelect
                  id="gitlab-sync-owner"
                  name="org"
                  value={selectedOwner}
            ...
            <OLCol xs={5}>
              <OLFormGroup>
                <OLFormLabel htmlFor="gitlab-sync-name">
                  {t('repository_name')}
                </OLFormLabel>
                <OLFormControl
                  id="gitlab-sync-name"
          ...
          <OLRow>
            <OLCol xs={12}>
              <OLFormGroup>
                <OLFormLabel htmlFor="gitlab-sync-description">
                  {t('description')} ({t('optional')})
                </OLFormLabel>
                <OLFormControl
                  id="gitlab-sync-description"
                  name="description"
                  type="text"
                  value={description}
              ...
              <OLRow>
                <OLCol xs={12}>
                  <OLFormCheckbox
                    ...
                    description={t('gitlab_public_description')}
                  />
                </OLCol>
              </OLRow>
              ...
              <OLRow>
                <OLCol xs={12}>
                  <OLFormCheckbox
                    ...
                    description={t('gitlab_private_description')}
                  />
                </OLCol>
              </OLRow>
            </OLFormGroup>
